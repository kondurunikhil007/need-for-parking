            ...
            <div class="w3-row-padding">
                <div class="w3-third">
                   ...
                   <!-- <select class="w3-select w3-text-lod" title="Select a Blood Group" name="bloodgroup1" id="bloodgroup1">
                    ...
                    <select class="w3-select w3-padding-16 w3-large w3-border-0 w3-text-lod" title="Select a vehicle type" name="rldrop" id="rldrop">
                         <option selected="selected" value="null">SELECT VEHICLE TYPE</option>
                            <option value="2">TWO WHEELER</option>
                            <option value="4">FOUR WHEELER </option>
                    </select>
                ...
                <div class="w3-third">
                    <input type="button" onclick="DB_Search()" title="Click to search for parked vehicle" value="search for vehicle" class="w3-btn w3-padding-16 w3-round w3-green" name="rlsearch" id="rlsearch">
                </div>
